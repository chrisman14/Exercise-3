...
$.getJSON(newURL, function (data) {
  ...
  $.each(planets, function (i, data) {
    $('#get-data').append('<tr><td>' + data.name + '</td><td>' + data.rotation_period + '</td><td>' + data.orbital_period + '</td><td>' + data.diameter + '</td><td>' + data.climate + '</td><td>' + data.gravity + '</td><td>' + data.terrain + '</td><td>' + data.surface_water + '</td><td>' + data.population + '</td><td><a href="' + data.residents + '">show here</a></td><td><a href="' + data.films + '">show here</a></td></tr>');
  });
